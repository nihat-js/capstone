...
const FTP_TEMPLATE_CONFIGS = {
  'Anonymous FTP': {
    port: 2121,
    ftpBanner: '220 Welcome to Anonymous FTP Server',
    allowAnonymous: true,
    maxConnections: 50,
    sessionTimeout: 300,
    passiveMode: true
  ...
  'Secure FTP': {
    port: 2121,
    ftpBanner: '220 Secure FTP Server Ready',
  ...
  'Legacy FTP': {
    port: 21,
    ftpBanner: '220 FTP Server v1.0 Ready',
    allowAnonymous: true,
    maxConnections: 100,
    sessionTimeout: 120,
    passiveMode: false
      ...
      <Content>
        <ConfigSection>
          ...
          <ConfigField>
            ...
            />
            <FieldDescription>Port to listen on (default: 2121)</FieldDescription>
          </ConfigField>
        </ConfigSection>

        <ConfigSection>
          <SectionTitle>FTP Configuration</SectionTitle>
